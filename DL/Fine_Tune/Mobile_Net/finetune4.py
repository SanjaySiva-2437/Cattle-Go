...
MODEL_PATH = "cattle_breed_mobilenetv2_finetuned_v5.keras"
...
# -------------------------
N = 100  # adjust depending on overfitting
...
# -------------------------
# 6. Compute class weights (fixed)
# -------------------------
y_train = train_generator.classes  # NumPy array
...
checkpoint = ModelCheckpoint(
    "cattle_breed_mobilenetv2_finetuned_v6.keras",

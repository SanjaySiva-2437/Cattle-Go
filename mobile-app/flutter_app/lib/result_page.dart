        ...
        child: Column(
          ...
          children: [
            ...
            if (hasError)
              ...
              _buildResultRow(Icons.bar_chart, "Confidence", confidence, deepGreen),
              _buildResultRow(Icons.info_outline, "Description", description, deepGreen),
              _buildResultRow(Icons.message_outlined, "Server Message", serverMessage, deepGreen),
            ],
          ],
        ),
      ),
